    ...
    <>
      ...
      >
        ...
        <span className="flex space-x-1">
          <kbd className="px-1 y-0.5 text-xs bg-zinc-700 rounded">ctrl</kbd>
          <kbd className="px-1 y-0.5 text-xs bg-zinc-700 rounded">k</kbd>
        </span>
      </button>
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        <div className="bg-zinc-900 border border-zinc-800">
          ...
          <CommandList className="bg-zinc-900">
            <CommandEmpty className="text-gray-500 py-6 text-center">No result found</CommandEmpty>
            <CommandGroup>
