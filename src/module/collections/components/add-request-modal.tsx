...
import { useAddRequestToCollection } from "@/module/request/hooks/request";
...
const SaveRequestToCollectionModal = ({
  ...
  const { mutateAsync, isPending } =
    ...
    useEffect(()=>{
      if(!isModalOpen) return; //if not open, just return
      if(collectionId) return; //if collectionId is provided, do not auto select
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="relative">
            <Input
              className="w-full p-3 bg-zinc-800 border border-zinc-700 rounded-lg text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent pr-20"
        ...
        <div>
          ...
          <div className="relative mb-3">
            ...
            <Input
              type="text"
              placeholder="Search"
              className="w-full bg-zinc-800 border border-zinc-700 rounded-lg pl-10 py-2 pr-4 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              value={searchTerm}
