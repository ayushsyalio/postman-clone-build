...
import CreateCollection from "@/module/collections/components/createCollection";
import EmptyCollection from "@/module/collections/components/empty-collection";
import CollectionFolder from "@/module/collections/components/collection-folder";
...
const TabbedSidebar = ({ currentWorkspace }: Props) => {
  ...
  return (
    <div className="flex h-screen bg-zinc-900">
      <div className="w-12 bg-zinc-900 border-r border-zinc-800 flex flex-col items-center justify-center py-4 space-y-4">
